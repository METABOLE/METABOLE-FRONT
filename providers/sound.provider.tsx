...
export const SoundProvider = ({ children }: { children: ReactNode }) => {
  ...
  const setIsSoundOn = (newIsSoundOn: boolean) => {
    _setIsSoundOn(newIsSoundOn);

    try {
      localStorage.setItem(SOUND_STORAGE_KEY, newIsSoundOn.toString());
    } catch (error) {
  ...
  return (
    <SoundContext.Provider value={{ isSoundOn, setIsSoundOn, toggleSound, initializeAudio }}>
      {children}
